...
const MainSlider = () => {
  return (
    <Swiper
      ...
      className='mainSlider h-full bg-primary xl:bg-mainSlider xl:bg-no-repeat max-w-lg lg:max-w-none
              ...
              <SwiperSlide key={index}>
                ...
                h-full p-[20px] md:p-[40px]'>
                  ...
                  <div className='flex-1'>
                    <img
                      className='xl:absolute xl:right-0 xl:-bottom-12'
                      src={slide.img}
                      alt='' />
                  </div>
                </div>
